...
//
//        View home = LayoutInflater.from(requireContext()).inflate(R.layout.home,null);
//        viewPager2 = home.findViewById(R.id.pager);
//
...
//                int nextPostion = (currentPosition + 1) % adapter.getItemCount();
//
//                viewPager2.setCurrentItem(nextPostion,true);
//            }
//        });
//    }
}
