        ...
        navigationBarView.setOnItemReselectedListener(new NavigationBarView.OnItemReselectedListener() {
            ...
            public void onNavigationItemReselected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.ranking) {
                    getSupportFragmentManager().beginTransaction().replace(R.id.content_scroll, ranking).commit();
                } else if (itemId == R.id.market) {
                    getSupportFragmentManager().beginTransaction().replace(R.id.content_scroll, market).commit();
                } else if (itemId == R.id.community) {
                    getSupportFragmentManager().beginTransaction().replace(R.id.content_scroll, community).commit();
                } else if (itemId == R.id.mypage) {
                    getSupportFragmentManager().beginTransaction().replace(R.id.content_scroll, mypage).commit();
                }
            }
        });
    }
