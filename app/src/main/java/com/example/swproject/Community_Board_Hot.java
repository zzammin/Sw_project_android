...
public class Community_Board_Hot extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.community_board_hot,container,false);
        Button backBtn = (Button)rootView.findViewById(R.id.hot2Community);
    ...
    private void changeFragmentWithData(String title, String content, String userid, int number) {
        ...
        Post_hot post_hot = new Post_hot();
        post_hot.setArguments(bundle);

        // Fragment 변경
        requireActivity().getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment_linear, post_hot)
                .addToBackStack(null)
                .commit();
    }
